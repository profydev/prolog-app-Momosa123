...
import { Badge, BadgeColor, BadgeStatus } from "@features/ui";
...
const badgeTag = {
  [ProjectStatus.stable]: BadgeStatus.info,
  [ProjectStatus.warning]: BadgeStatus.warning,
  [ProjectStatus.critical]: BadgeStatus.error,
};
